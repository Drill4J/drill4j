@file:Suppress("unused", "RemoveSingleExpressionStringTemplate", "RemoveEmptyClassBody", "UNCHECKED_CAST",
    "NON_EXHAUSTIVE_WHEN", "MemberVisibilityCanBePrivate", "SimplifiableCallChain", "USELESS_ELVIS",
    "RegExpRedundantEscape", "UNUSED_VARIABLE", "RemoveExplicitTypeArguments", "UNUSED_ANONYMOUS_PARAMETER"
)

package io.ktor.swagger
